...
const Statistics = () => {
    const { stats: data } = useControlsContext();
    const stats = [
        { text: 'Visited Nodes:', val: data.nodes },
        { text: 'Path Length:', val: data.pathLength },
        { text: 'Time Taken:', val: data.time },
    ];
    return (
